namespace WasteDetection.Services
{
    public class SettingsService
    {
        ...
        public string GetGDALToolsScriptsPath()
        {
            string? gdalToolsPath = _configuration.GetValue<string>("GDALToolsScriptsPath");
            if (string.IsNullOrEmpty(gdalToolsPath))
                throw new Exception("GDAL Tools Script Path Not Found");
